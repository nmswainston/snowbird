...
def render_dashboard():
    """Render the professional main dashboard with overview cards and quick stats"""
    # Professional dashboard header
    st.markdown("""
    <div class="dashboard-header">
        <div class="dashboard-title-section">
            <h2><i data-lucide="layout-dashboard" class="icon"></i>Financial Dashboard</h2>
            <p class="dashboard-subtitle">Your complete seasonal financial overview</p>
        </div>
